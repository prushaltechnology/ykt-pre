    ...
    const settings = {
      ...
      return (
        <div className=' m-auto bord'>
          ...
          <Slider {...settings}>
            {data.map((d) => (
              <div key={d.name}  className="custom-bg-pink h-[550px] text-black rounded-xl ">
                ...
                <div className="flex flex-col items-center justify-center gap-0 p-4">
                  ...
                  <p className="text-l font-semibold">{d.title}</p>
                  <p className="text-center text-lg font-semibold">{d.city}</p>
                  <p className='text-center gap-0'>⭐️⭐️⭐️⭐️⭐</p>
